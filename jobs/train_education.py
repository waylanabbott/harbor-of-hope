"""
Train: Education Outcome Classifier (Predictive)
Reads ml_education_features, trains sklearn Pipeline,
...
def run():
    ...
    with open(os.path.join(ARTIFACTS_DIR, "education_outcome_metadata.json"), "w") as f:
    ...
    with open(os.path.join(ARTIFACTS_DIR, "education_outcome_metrics.json"), "w") as f:
